namespace xofz.TimeKeeper98.Tests.Framework.Home
{
    ...
    public class OutKeyTappedHandlerTests
    {
        public class Context
        {
            protected Context()
            {
                ...
                this.handler = new OutKeyTappedHandler(
                    this.web);
            ...
            protected readonly OutKeyTappedHandler handler;
        ...
        public class When_Handle_is_called : Context
        {
            ...
            [Fact]
            public void Sets_OutKeyVisible_to_false()
            {
